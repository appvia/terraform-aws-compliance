...
module "config_rule_groups" {
  ...
  exclude_accounts     = each.value.exclude_accounts == null ? [] : each.value.exclude_accounts
  organizational_units = each.value.associations == null ? [] : each.value.associations
